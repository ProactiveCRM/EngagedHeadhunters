...
const NichePage = () => {
  ...
  const seoKeywords = currentNiche.specialties.join(', ') + `, ${currentNiche.title} recruiting, ${currentNiche.title} headhunter, ${currentNiche.title} executive search`;

  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title={`${currentNiche.title} Recruiting & Executive Search`}
        description={seoDescription}
        canonical={`/niches/${niche}`}
        type="service"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center mb-6">
                <div className="bg-primary-foreground/20 w-20 h-20 rounded-full flex items-center justify-center mr-4">
                  <span className="text-4xl" role="img" aria-hidden="true">{currentNiche.emoji}</span>
                </div>
                <div>
                  <h1 className="text-4xl md:text-5xl font-bold mb-2">{currentNiche.title} Recruiting</h1>
            ...
            <div className="grid grid-cols-2 gap-6 text-center">
              <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-lg p-6">
                <div className="text-3xl font-bold mb-2">{currentNiche.placements}</div>
                <div className="text-primary-foreground/80">Placements</div>
              </div>
              <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-lg p-6">
                <div className="text-3xl font-bold mb-2">{currentNiche.avgSalary}</div>
                <div className="text-primary-foreground/80">Avg. Salary</div>
              </div>
              <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-lg p-6">
                <div className="text-3xl font-bold mb-2">{currentNiche.avgTimeToFill}</div>
                <div className="text-primary-foreground/80">Avg. Fill Time</div>
              </div>
              <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-lg p-6">
                <div className="text-3xl font-bold mb-2">{currentNiche.successRate}</div>
            ...
            <div className="bg-background rounded-xl p-8 border">
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-primary mb-2">{currentNiche.featuredAgent.title}</p>
                  ...
                  <div className="flex space-x-4">
                    ...
                    <a 
                      ...
                      className="flex-1 bg-accent text-accent-foreground hover:bg-accent/80 px-6 py-3 rounded-lg font-semibold text-center transition-colors inline-flex items-center justify-center"
                    >
