                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <h1 className="text-4xl md:text-5xl font-bold text-foreground leading-tight mb-6 text-left">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                                    ...
                                    <a
                                        ...
                                        className="bg-primary text-primary-foreground px-8 py-4 rounded-lg font-semibold hover:bg-primary/90 transition-colors flex items-center justify-center whitespace-nowrap"
                                    >
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <ul className="grid md:grid-cols-3 gap-8 list-none" aria-label="Technology job categories">
                            {techCategories.map((category, index) => (
                                <li key={index} className="bg-card rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-border text-foreground">
                                    ...
                                    <ul className="space-y-3 mb-6 list-none text-left" aria-label={`Popular roles in ${category.title}`}>
                            ...
                            {techStacks.map((stack, index) => (
                                <li key={index} className="bg-card rounded-lg p-6 shadow-md border border-border">
                                    <div className="flex justify-between items-center bg-card">
                                        ...
                                        <span
                                            className={`px-3 py-1 rounded-full text-xs font-medium ${stack.demand === 'Very High'
...
export default TechnologyCareersClient;
