            ...
            <main id="main-content" className="pt-20">
                <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input placeholder="John Smith" {...field} className="bg-background text-foreground border-border" />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input type="email" placeholder="john@example.com" {...field} className="bg-background text-foreground border-border" />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input type="password" placeholder="••••••••" {...field} className="bg-background text-foreground border-border" />
                                                    </FormControl>
                                                    <FormDescription className="text-muted-foreground">Must be at least 8 characters</FormDescription>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
                                        />
                                ...
                                <Form {...profileForm}>
                                    <form onSubmit={profileForm.handleSubmit(onProfileSubmit)} className="space-y-6">
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input placeholder="Senior Executive Recruiter" {...field} className="bg-background text-foreground border-border" />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
                                                ...
                                                <FormItem>
                                                    ...
                                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                        ...
                                                        <SelectContent className="bg-background text-foreground border-border">
                                                            {NICHES.map((niche) => (
                                                                <SelectItem key={niche} value={niche} className="hover:bg-muted font-medium cursor-pointer">{niche}</SelectItem>
                                                            ))}
                                                        </SelectContent>
                                                    </Select>
                                                    <FormMessage />
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input placeholder="Houston, TX" {...field} className="bg-background text-foreground border-border" />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormDescription className="text-muted-foreground">{(field.value?.length || 0)}/500 characters</FormDescription>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
                                        />
                                        ...
                                        <div className="flex gap-4">
                                            <Button type="button" variant="outline" onClick={() => setStep(1)} className="flex-1 border-border text-foreground hover:bg-muted">
                    ...
                    {step === 3 && (
                        <Card className="bg-card text-card-foreground border-border shadow-md">
                            <CardHeader className="text-left">
                                <CardTitle className="text-2xl font-bold">Set Up Booking (Optional)</CardTitle>
                            </CardHeader>
                            <CardContent className="text-left">
                                <Form {...bookingForm}>
                                    <form onSubmit={bookingForm.handleSubmit(onBookingSubmit)} className="space-y-6">
                                        ...
                                        <div className="flex gap-4">
                                            <Button type="button" variant="outline" onClick={() => setStep(2)} className="flex-1 border-border text-foreground hover:bg-muted">
                                                <ArrowLeft className="mr-2 w-4 h-4" />
                                                Back
                                            </Button>
...
export default RecruiterSignupClient;
