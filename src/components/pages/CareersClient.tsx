            ...
            <main id="main-content">
                ...
                <section className="bg-gradient-to-br from-muted to-background pt-28 md:pt-32 pb-16">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        {/* Job Search Bar */}
                        <div className="bg-card rounded-xl shadow-lg p-6 max-w-4xl mx-auto mb-12 border border-border">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8">
                            {careerCategories.map((category, index) => (
                                <Link
                                    key={index}
                                    href={`/${category.slug}-careers`}
                                    className="bg-card rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 p-8 border border-border group"
                                >
